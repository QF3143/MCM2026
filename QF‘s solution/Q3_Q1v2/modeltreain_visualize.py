...
# --- 1. 加载数据 ---
# 确保文件在当前目录下
df = pd.read_csv('QF‘s solution/Q3_Q1v2/Processed_Feature_Matrix.csv')
...
imp_df.to_csv("QF‘s solution/Q3_Q1v2/importance.csv")
...
plt.tight_layout()
plt.savefig('QF‘s solution/Q3_Q1v2/contrast_butterfly_chart.png', dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig('QF‘s solution/Q3_Q1v2/age_dynamics_contrast.png', dpi=300)
plt.show()
